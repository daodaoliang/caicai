...
namespace DataBase
{
    #region Class SqlHerlper
    /// <summary>
    /// 数据库操作类
    /// </summary>
    public class SqlHelper_MySql
    {
        ...
        /// <returns></returns>
        public static DataTable ExecuteDataTable(string connectionString, string _Sql)
        {
            return ExecuteDataTable(connectionString, CommandType.Text, _Sql, (MySqlParameter[])null);
        }
        /// <summary>
        /// Execute a MySqlCommand (that returns a resultset and takes no parameters) against the database specified in 
        /// the connection string. 
        ...
        {
            // Pass through the call providing null for the set of SqlParameters
            return ExecuteDataTable(connection, CommandType.Text, commandText, (MySqlParameter[])null);
        }
        /// <summary>
        /// Execute a MySqlCommand (that returns a resultset and takes no parameters) against the provided MySqlConnection. 
        /// </summary>
    ...
    #region Class MySqlHelperParameterCache
    /// <summary>
